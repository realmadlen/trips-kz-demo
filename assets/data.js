...
window.Data = (function () {
  ...
  var REVIEWS = [
    ...
    /* Три отзыва про работу агентства, а не про отель: рейс перенесли, деньги
       вернули, документы переделали. Все двенадцать предыдущих рассказывали
       про пляж и шведский стол — то есть отвечали на вопрос «куда ехать»,
       а не на тот, ради которого выбирают агентство. */
    { id: 'r13', about: 'agency', who: { ru: 'Гульнара А.', kk: 'Гүлнара Ә.', en: 'Gulnara A.' }, hotel: 'Sunrise Bay Resort & Spa', place: { ru: 'Анталья, Турция', kk: 'Анталья, Түркия', en: 'Antalya, Türkiye' }, when: '2026-07', rate: 4.8, likes: 41,
      text: { ru: 'Рейс перенесли на сутки за два дня до вылета. Менеджер позвонила сама, до того как я увидела письмо от авиакомпании: предложила два варианта — сдвинуть весь тур или взять ночь в отеле у аэропорта за счёт оператора. Выбрали второе, ваучер переделали за час. Это единственное, что я хотела проверить на агентстве, и оно сработало.',
              kk: 'Ұшуға екі күн қалғанда рейс бір тәулікке ауысты. Менеджер әуекомпанияның хатын көрмей тұрып өзі қоңырау шалды: екі нұсқа ұсынды — бүкіл турды жылжыту немесе әуежай маңындағы қонақүйде оператор есебінен түнеу. Екіншісін таңдадық, ваучерді бір сағатта қайта жасады.',
              en: 'The flight moved by a day, two days before departure. The manager called before I even saw the airline email and offered two options: shift the whole package or take a night at an airport hotel at the operator’s expense. We took the second; the voucher was reissued within an hour.' } },
    { id: 'r14', about: 'agency', who: { ru: 'Тимур Ж.', kk: 'Тимур Ж.', en: 'Timur Zh.' }, hotel: 'Coral Sands Resort', place: { ru: 'Хургада, Египет', kk: 'Хургада, Мысыр', en: 'Hurghada, Egypt' }, when: '2026-04', rate: 4.2, likes: 23,
      text: { ru: 'Пришлось отменить поездку из-за больницы. Вернули не всё — оператор удержал сбор, и об этом сказали сразу, в тот же день, а не после трёх звонков. Деньги пришли на карту через одиннадцать дней, как и обещали. Неприятно, но честно.',
              kk: 'Ауруханаға байланысты сапарды болдырмауға тура келді. Бәрін қайтармады — оператор алымды ұстады, бірақ бұл туралы үш қоңыраудан кейін емес, сол күні айтты. Ақша он бір күнде картаға түсті.',
              en: 'We had to cancel because of hospital. Not everything came back — the operator kept a fee, and they said so the same day rather than after three calls. The money reached the card in eleven days, as promised.' } },
    { id: 'r15', about: 'agency', who: { ru: 'Асем К.', kk: 'Әсем Қ.', en: 'Assem K.' }, hotel: 'Horizon Palace', place: { ru: 'Дубай, ОАЭ', kk: 'Дубай, БАӘ', en: 'Dubai, UAE' }, when: '2026-02', rate: 4.5, likes: 17,
      text: { ru: 'В фамилии ребёнка в билете была ошибка — не по вине агентства, я сама так написала в заявке. Исправили бесплатно за день до вылета, хотя авиакомпания брала за это деньги. Сказали, что берут на себя.',
              kk: 'Билеттегі баланың тегінде қате болды — агенттіктің кінәсі емес, өтінімде өзім солай жаздым. Ұшудан бір күн бұрын тегін түзетті, әуекомпания бұл үшін ақы алса да.',
              en: 'There was a mistake in our child’s surname on the ticket — my own fault, I typed it that way. They fixed it free of charge the day before departure, even though the airline charges for that.' } }
  ];
  ...
  /* У каждого в команде есть одно действие: у того, кто ведёт направление, —
     ссылка на выдачу по этому направлению, у остальных — заявка. Без этого
     блок был витриной лиц, из которой некуда идти. */
  var TEAM = [
    { id: 't1', act: 'lead', img: 'team-dinara', since: 2016, langs: ['ru', 'kk', 'en'],
    ...
    { id: 't2', act: 'lead', img: 'team-yerzhan', since: 2017, langs: ['ru', 'kk'],
    ...
    { id: 't3', to: 'tr', img: 'team-aliya', since: 2019, langs: ['ru', 'kk', 'tr'],
    ...
    { id: 't4', to: 'th', img: 'team-timur', since: 2020, langs: ['ru', 'kk', 'en'],
    ...
    { id: 't5', act: 'lead', img: 'team-maria', since: 2021, langs: ['ru', 'en'],
    ...
    { id: 't6', act: 'lead', img: 'team-asel', since: 2023, langs: ['ru', 'kk'],
    ...
    { id: 't7', to: 'eg', img: 'team-saule', since: 2018, langs: ['ru', 'kk', 'ar'],
      name: { ru: 'Сауле Ибраева', kk: 'Сәуле Ибраева', en: 'Saule Ibrayeva' },
      role: { ru: 'Менеджер по Египту', kk: 'Египет бойынша менеджер', en: 'Egypt manager' },
      note: { ru: 'Помнит, где на Красном море заходят в воду с берега, а где нужны кораллки.',
              kk: 'Қызыл теңізде қай жерде жағадан суға кіруге болатынын, қай жерде маржан аяқкиім керегін біледі.',
              en: 'Remembers where on the Red Sea you can wade in and where reef shoes are a must.' } },
    { id: 't8', to: 'ge', img: 'team-daniyar', since: 2021, langs: ['ru', 'kk', 'en'],
      name: { ru: 'Данияр Оспанов', kk: 'Данияр Оспанов', en: 'Daniyar Ospanov' },
      role: { ru: 'Менеджер по горнолыжным турам', kk: 'Тау шаңғысы турлары бойынша менеджер', en: 'Ski holidays manager' },
      note: { ru: 'Сравнивает склоны и подъёмники, а не только звёзды отеля.',
              kk: 'Қонақүй жұлдызын ғана емес, беткейлер мен көтергіштерді салыстырады.',
              en: 'Compares slopes and lifts, not just the hotel’s star rating.' } },
    { id: 't9', to: 'kz', img: 'team-aigerim', since: 2022, langs: ['ru', 'kk'],
      name: { ru: 'Айгерим Касымова', kk: 'Айгерім Қасымова', en: 'Aigerim Kassymova' },
      role: { ru: 'Менеджер по Казахстану и Кыргызстану', kk: 'Қазақстан және Қырғызстан бойынша менеджер', en: 'Kazakhstan and Kyrgyzstan manager' },
      note: { ru: 'Ведёт Алаколь, Боровое, Кендерли и Иссык-Куль — с дорогой и трансферами.',
              kk: 'Алакөл, Бурабай, Кендірлі және Ыстықкөлді жүргізеді — жол мен трансферімен қоса.',
              en: 'Handles Alakol, Borovoe, Kenderli and Issyk-Kul, transfers included.' } },
    { id: 't10', act: 'lead', img: 'team-oleg', since: 2019, langs: ['ru', 'en'],
      name: { ru: 'Олег Ким', kk: 'Олег Ким', en: 'Oleg Kim' },
      role: { ru: 'Авиаотдел: перелёты и стыковки', kk: 'Авиабөлім: рейстер мен ауысулар', en: 'Flights desk' },
      note: { ru: 'Собирает перелёт отдельно от тура, когда так выходит дешевле или удобнее.',
              kk: 'Арзанырақ немесе ыңғайлырақ болса, рейсті турдан бөлек жинайды.',
              en: 'Books the flight separately from the package when that works out cheaper.' } },
    { id: 't11', act: 'lead', img: 'team-kamila', since: 2020, langs: ['ru', 'kk', 'en'],
      name: { ru: 'Камила Абишева', kk: 'Камила Әбішева', en: 'Kamila Abisheva' },
      role: { ru: 'Групповые и корпоративные заезды', kk: 'Топтық және корпоративтік сапарлар', en: 'Groups and corporate travel' },
      note: { ru: 'Считает выезды от десяти человек: блоки мест, договор, закрывающие документы.',
              kk: 'Он адамнан бастап сапарларды есептейді: орын блоктары, шарт, жабатын құжаттар.',
              en: 'Prices trips from ten people up: seat blocks, contracts, closing paperwork.' } },
    { id: 't12', act: 'lead', img: 'team-nurlan', since: 2024, langs: ['ru', 'kk'],
      name: { ru: 'Нурлан Тлеубаев', kk: 'Нұрлан Тілеубаев', en: 'Nurlan Tleubayev' },
      role: { ru: 'Оплата и рассрочка', kk: 'Төлем және бөліп төлеу', en: 'Payments and instalments' },
      note: { ru: 'Объясняет, из чего складывается цена и что происходит с деньгами при отмене.',
              kk: 'Баға неден құралатынын және сапар күшін жойғанда ақшамен не болатынын түсіндіреді.',
              en: 'Explains what makes up the price and what happens to the money if you cancel.' } }
  ];
