...
(function () {
  ...
  /* Карусель статей: прокрутка на ширину видимой части, стрелки гаснут
     на краях — доехать «дальше конца» кнопка обещать не должна. */
  function syncRail() {
    var rail = qs('[data-articles]'), nav = qs('[data-rail-nav]');
    if (!rail || !nav) return;
